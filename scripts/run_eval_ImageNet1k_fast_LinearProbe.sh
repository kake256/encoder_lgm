...
# データ設定
USE_DATA="ImageNet1k_FULL" #"imagenet100_orignal" #"imagenet100_FULL" #"imagenet100_FULL_batch"
DATASET_DIR="$PROJECT_ROOT/makeData/dataset_clean_$USE_DATA"
DATASET_TYPE="imagenet"
# HFデータセット引数
HF_ARGS="--imagenet_hf_dataset imagenet-1k --imagenet_hf_test_split validation"
...
SELECTED_EVALUATORS="ResNet50 OpenCLIP_RN50 MAE CLIP DINOv2"  
NUM_TRIALS=5 #5
...
REAL_BASELINE_COUNTS="1" #1000" #"1400" 
