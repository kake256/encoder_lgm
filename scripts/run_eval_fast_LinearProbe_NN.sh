...
# データ設定
USE_DATA="imagenet100_FULL_prototype_DINOv1"
#USE_DATA="imagenet100_FULL" #"imagenet100_orignal" #"imagenet100_FULL" #"imagenet100_FULL_batch"
...
REAL_BASELINE_COUNTS="" #"1400" 

TIMESTAMP=$(date +%Y%m%d_%H%M%S)
OUTPUT_DIR="$PROJECT_ROOT/evaluation_results_fast/NN/${USE_DATA}/${EVAL_MODE}_${KD_MODE}_${TIMESTAMP}"
mkdir -p "$OUTPUT_DIR"
