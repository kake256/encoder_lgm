...
DATASETS=(
  "$PROJECT_ROOT/makeData/dataset_clean_ImageNet1k_200:ImageNet1k_200"
  "$PROJECT_ROOT/makeData/dataset_clean_ImageNet1k:ImageNet1k"
)
...
for DATASET_INFO in "${DATASETS[@]}"; do
    ...
    for CURRENT_MODE in "linear_torch" "scratch"; do 
