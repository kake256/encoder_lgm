...
SELECTED_EVALUATORS="DINOv1 DINOv2 CLIP SigLIP"
...
NOTIFY_SCRIPT="$PROJECT_ROOT/src/send_notification.py"
...
CURRENT_OUTPUT_DIR="$PROJECT_ROOT"
...
# 4. ImageNet-100
# ディレクトリ: makeData/dataset_clean_ImageNet1k_200
run_dataset_cycle "imagenet100" "imagenet100" "clane9/imagenet-100" "validation"
