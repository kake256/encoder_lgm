...
DEFAULT_DATASET_DIR="$PROJECT_ROOT/makeData/dataset_typo_ImageNet1k_200"
...
#for CURRENT_MODE in "linear_torch" "partial_ft" "full_ft"; do # Mode 切り替え
  ...
  OUTPUT_DIR="$PROJECT_ROOT/evaluation_results_critique/ImageNet1k_200_typo/${TIMESTAMP}_${EVAL_MODE}"
  mkdir -p "$OUTPUT_DIR"
