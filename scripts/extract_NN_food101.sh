#!/bin/bash
# run_extract_nearest_food101.sh
set -euo pipefail
...
# ※Food101の実際のフォルダ名に合わせて変更してください（例: food101_FULL, food101_original など）
DATA="food101_FULL"
...
# 実画像を検索するHuggingFaceデータセット (Food101に変更)
...
MODELS="ResNet50 MAE OpenCLIP_RN50 DINOv2  DINOv1 CLIP SigLIP"
...
echo "========================================================"
echo " Starting Nearest Prototype Extraction (Food101)"
echo "========================================================"
