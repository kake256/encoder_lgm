...
# データ設定
#encoder_lgm/makeData/imagenet100_FULL_prototype_mean/dataset_nearest_OpenCLIP_RN50
#USE_DATA="imagenet100_FULL_prototype_ResNet50" #"imagenet100_orignal" #"imagenet100_FULL" #"imagenet100_FULL_batch"
USE_DATA="imagenet100_FULL_prototype_mean/dataset_nearest_ResNet50"
DATASET_DIR="$PROJECT_ROOT/makeData/$USE_DATA"
...
# --- 実験設定 ---
SELECTED_EVALUATORS="OpenCLIP_RN50" #MAE " #"ResNet50 MAE OpenCLIP_RN50"
NUM_TRIALS=5 #5

SYN_COUNTS="5" #"1 5"

# [変更点] ここを空文字 "" にすると、実画像ベースラインをスキップします
# 例: REAL_BASELINE_COUNTS="1 3 5" で有効化、REAL_BASELINE_COUNTS="" でスキップ
REAL_BASELINE_COUNTS="" 
